...
const Img = () => {
  return (
    <div className="w-full lg:w-3/5 h-64 lg:h-screen relative border border-black">
            <Image
              alt="Scenic travel destination showcasing Roamio's adventure possibilities"
            ...
            <div className="absolute inset-0 flex items-center mx-15">
              <h2 className="text-3xl lg:text-6xl font-bold text-white text-center px-4">
                Join <span className="text-[#2FFD74] italic font-mono">Roamio</span> and<br /> turn travel plans<br /> into reality.
              </h2>
            </div>
    
            {/* Learn More button at the bottom-left */}
